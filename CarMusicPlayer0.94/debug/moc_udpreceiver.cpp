...
QT_MOC_LITERAL(1, 12, 8), // "received"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7) // "receive"

    },
    "UDPReceiver\0received\0\0receive"
};
...
void UDPReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->received((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (UDPReceiver::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UDPReceiver::received)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UDPReceiver::received(QString _t1)
{
